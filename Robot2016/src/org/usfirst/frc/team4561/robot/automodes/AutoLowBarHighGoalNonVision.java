 ...
 * 
 */
public class AutoLowBarHighGoalNonVision extends CommandGroup {
    ...
    public  AutoLowBarHighGoalNonVision() {
    	// Lower Arms to prep for low bar
    	addSequential(new LowerArms(), 1.3);
    	// Wait for gravity
    	addSequential(new WaitCommand(3.0));
    	// Drive through low bar
    	addSequential(new DriveArcadeTimed(-0.5, 0, 2));
    	// Raise arms to shooter position
    	addSequential(new RaiseArms(), 2.0);
    	// Turn to face goal
    	addSequential(new DriveArcadeTimed(0, 0.75, 1));
